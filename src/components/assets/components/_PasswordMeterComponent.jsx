...
class PasswordMeterComponent {
  ...
  // Static methods
  static getInstance = (el, componentName = defaultPasswordMeterQueires.componentName) => {
  ...
  static reinitialization = (selector = defaultPasswordMeterQueires.instanseQuery) => {
    PasswordMeterComponent.createInstances(selector)
  }
}
